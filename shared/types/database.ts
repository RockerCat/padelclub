...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      _notify_eligible_tournament_players: {
        Args: {
          p_message: string
          p_metadata?: Json
          p_title: string
      ...
      _notify_tournament_entry_players: {
        Args: {
          p_exclude_club_member_id?: string
          p_message: string
          p_metadata?: Json
          p_title: string
      ...
      effective_club_role: { Args: { p_club_id: string }; Returns: string }
