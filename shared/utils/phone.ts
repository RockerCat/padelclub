...
// Reutilizada por el registro de PLAYER (SignupForm), por el botón de
// WhatsApp del modal de administración (MemberModal), por Mi Perfil
// (PhoneEditField) y, del lado mobile, por ProfileScreen y ChangeClubScreen
// (flujo "completa tu WhatsApp" al unirse a un club). WEB re-exporta esta
// misma función bajo su nombre histórico (src/lib/utils/phone.ts) para que
// ningún import existente cambie; mobile la usa directo
