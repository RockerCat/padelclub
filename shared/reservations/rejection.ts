...
//
// Portado de src/lib/reservationRejection.ts (app web) — misma fuente única
// que mobile ahora también usa (ver CLAUDE.md → Reservation Status
// Principles: "un solo catálogo, nunca una segunda copia").
