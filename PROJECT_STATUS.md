...
El Funnel Comercial v1 (captación de leads → gestión SUPERADMIN → conversión a Entrega de Club), Comercial v2 / Fase 1 (capa comercial base + trial automático de 30 días al reclamar el club) y Comercial v2 / Fase 2 (entitlement — bloqueo de creación de reservas/torneos nuevos cuando el club está `suspended`, más el banner global OWNER) tampoco son funcionalidades futuras — los tres están implementados y validados en producción (ver Funnel Comercial (v1), Comercial v2 — Fase 1 y Comercial v2 — Fase 2). "Pagos" arriba se refiere específicamente a lo que sigue sin implementarse (Comercial v2 / Fase 3): Wompi, cobro real, renovación automática, y el CTA "Reactivar suscripción" en el banner ya existente — el estado operativo `Activo` de un club nunca debe confundirse con una suscripción o trial activo.
